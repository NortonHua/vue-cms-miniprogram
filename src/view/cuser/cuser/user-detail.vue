        ...
        <el-row>
          <el-col :lg="16" :md="20" :sm="24" :xs="24">
            <el-form :model="form" status-icon ref="form" label-width="100px" @submit.native.prevent>
              ...
              <el-form-item>
                <el-avatar :size="60" :src="avatarUrl" @error="errorHandler"></el-avatar>
              </el-form-item>
              ...
              <el-form-item label="微信档案" prop="wx_profile">
                <div v-if="form.wx_profile">
                  <!--                                    <tree-view :data="JSON.parse(form.wx_profile)" :options="{maxDepth: 3}"></tree-view>-->
                </div>
              </el-form-item>
            </el-form>
          </el-col>
...
export default {
  ...
  methods: {
    async getThirdUser() {
      ...
      this.form = res
      if (res.wx_profile != null) {
        const avatar = JSON.parse(res.wx_profile).avatarUrl
        this.avatarUrl = avatar
      } else {
        this.avatarUrl = '123456'
      }
    },
