  ...
  <div class="container">
    <div class="lin-info">
      <div class="lin-info-left">
        <div class="welcome">
          <img src="../../assets/image/小尖角.png" class="welcome-title" alt="" />
          <div class="subtitle">
            <div class="guide">您还可以点击一日一甜官方网站，查看更多内容</div>
            <div class="link">
              <a href="https://www.onesweetoneday.com/other/yanhua/index.html" target="_blank"
                >https://www.onesweetoneday.com</a
              >
            </div>
          </div>
        </div>
      ...
      <div class="lin-info-right">
        <div class="team-detail">
          <div class="team-box">
            <div class="team-title">小店团队</div>
            <ul class="team-ul">
              <li>
                <span class="shadow-box"> <i class="team-shadow"></i> </span> <span class="team-role">店长</span>
                <span class="team-name">爱梅特赛尔克</span>
              </li>
              <li>
                <span class="shadow-box"> <i class="team-shadow"></i> </span> <span class="team-role">店员</span>
              ...
              <li>
                ...
                <span class="team-name">帕帕力莫</span>
              </li>
            </ul>
          </div>
          <div class="team-icon"><img src="../../assets/image/about/erweima.png" alt="" /></div>
          <p class="team-label">小程序二维码</p>
        </div>
      </div>
    </div>
